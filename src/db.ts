...
import { createCrushSchema } from './crush.js';
import { createLaundrySchema } from './laundry.js';
import { createQuestSchema } from './quests.js';
...
function createSchema(database: Database.Database): void {
  ...
  // Add thread_id column for forum topic support
  try {
  ...
  createCrushSchema(database);
  createQuestSchema(database);
}
